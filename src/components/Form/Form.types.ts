...
// набор правил ключ=назв поля
export type RulesMap<TValues extends FieldValues> = Partial<
Record<keyof TValues & string, FieldRule>
>;


// ошибки валид ключ=назв поля
export type Errors<TValues extends FieldValues> = Partial<
